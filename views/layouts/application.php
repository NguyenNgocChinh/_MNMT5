		...
		<div class="container-fluid">
			<div class="row">
				...
				<div class="col-lg-4" id="contact">
					<h3>Contact</h3>
					<i class="glyphicon glyphicon-map-marker"></i><span> 113 Hoàng Sa, Đa Kao, Tân Bình, Hồ Chí Minh, Việt Nam</span><br>
					<i class="glyphicon glyphicon-earphone"></i><span> (08) 123 123</span><br>
					<i class="glyphicon glyphicon-envelope"></i><span> 9XWatch@admin.com</span><br>
